...
class UserLoggedInService {
    ...
    addBook(book, customerId) {
        return this.http.post("https://houseofbooks.herokuapp.com/book/book/" + customerId, book, { responseType: 'text' });
    }
}
...
module.exports = __webpack_require__(/*! C:\Users\Al\Pictures\bookABook\src\main.ts */"./src/main.ts");
